...
class _DownloaderState extends State<Downloader> {
  ...
  Future<void> _downloadPlaylist(String downloadDir) async {
    ...
    try {
      ...
      final songDir = '$downloadDir/songs';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () =>
                                _downloadPlaylist('default_download_dir'),
                          )
                        ],
                      ),
                    ),
  ...
  Widget? _buildFAB() {
    ...
    if (_ffmpegInstalled && _spotdlInstalled) {
      return FloatingActionButton(
        onPressed: () => _downloadPlaylist('default_download_dir'),
